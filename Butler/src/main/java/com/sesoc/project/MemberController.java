...
public class MemberController {
	...
	//아이디 중복확인
		...
		@RequestMapping(value = "member/member_ModifyProcess", method = RequestMethod.POST)
		public String member_ModifyProcess(Model model, MemberVO vo, RedirectAttributes rttr) {
			dao.modifyMemberInfo(model, vo, rttr);
