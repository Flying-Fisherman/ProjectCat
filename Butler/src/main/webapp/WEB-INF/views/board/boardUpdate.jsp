...
<body>
  ...
  <form action="<c:url value = '/board/update'/>" method="post" id = "updateForm" enctype="multipart/form-data">
	...
	<div class='jumbotron' style="margin-left: 25%; margin-right: 25%; margin-top: 20px; background-color: #331C13;">
  	<div style="font-size: 24px; color: white;">コミュニテイー 修正</div>
	<table style="margin-top: 20px;margin-left: auto; margin-right: auto; border-radius: 10px;background-color: #6F3B29; width: 90%; border-color: black;" class='table'>
		<tr>
			...
			<td>
				<input type = "text" style="color: black; width:100%;" name = "title" id = "title1" value = "${read.title}" required = "required" style="width: 500px;color: black;">
