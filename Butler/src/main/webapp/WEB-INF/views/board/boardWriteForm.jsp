...
<body>
  ...
  <form action="<c:url value = '/board/write'/>" method="post" enctype="multipart/form-data">
  	...
  	<div style="font-size: 24px; color: white;">コミュニテイー 登録</div>
	<table style="margin-top: 20px;margin-left: auto; margin-right: auto; border-radius: 10px;background-color: #6F3B29; width: 90%; border-color: black;" class='table'>
		<tr>
			...
			<td>
				<input type = "text" style="color: black; width:100%;" name = "title" id = "title1" placeholder = "タイトル" required = "required" name = "title">
		...
		<tr>
			...
			<td>
				<input type = "file" name = "uploadFile" style="color: white; width:100%;" class='btn btn-default'>
			</td>
		</tr>
		<tr>
